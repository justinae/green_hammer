...
<div id="page_title"><img src="images/in_the_media.jpg" alt="Page Title: Contact" width="210" height="30" class="no_border" /></div>
...
<?php
   ...
   include("rssmedia.php");
   $url = "http://greenhammerconstruction.wordpress.com/category/media/feed/"; //this is the blogs url
   $rss=new rssFeed($url);
   if($rss->error){
