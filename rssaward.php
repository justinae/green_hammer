...
class newsStory{
	...
	function show(){
		if($this->title){
			if($this->link){
				echo "<div class=\"award\"><h4 class=\"no_margin\"><a href=\"$this->link\" target=\"_blank\" class=\"green\">$this->title</a></h4>\n";
			}elseif($this->title){
				echo "<div class=\"award\"><h4 class=\"no_margin\">$this->title</a></h4>\n";
			}
